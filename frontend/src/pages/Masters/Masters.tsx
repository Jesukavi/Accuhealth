...
const Masters: React.FC = () => {
  ...
  const handleMasterClick = (master: Master) => {
    ...
    if (master.id === 'role' || master.name === 'Role') {
      navigate('/roles');
      return;
    }
      ...
      <div className="min-h-screen bg-gray-50 py-12 px-6">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          (() => {
            ...
            const renderCard = (master: Master) => {
            ...
            return (
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
                {/* 1st — Role card */}
                {roleCard && renderCard(roleCard)}

                {/* 2nd — User Management card (Super Admin only) */}
                {isSuperAdmin && (
                  <div
                    className="bg-white rounded-lg border border-blue-200 p-8 cursor-pointer hover:shadow-lg transition-all duration-200 hover:border-blue-300"
