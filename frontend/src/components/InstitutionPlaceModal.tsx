...
interface InstitutionPlaceModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (data: any) => void;
}

const InstitutionPlaceModal: React.FC<InstitutionPlaceModalProps> = ({ isOpen, onClose, onSubmit }) => {
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden animate-scale-in">
                ...
                <div className="bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between">
                    <h2 className="text-xl font-bold text-gray-800">Add Institution/Place of vaccination</h2>
                    <button
                        onClick={onClose}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                value={formData.name}
                                onChange={handleInputChange}
                                placeholder="Institution/Place of vaccination"
                                className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                                required
                            />
                        </div>
...
export default InstitutionPlaceModal;
