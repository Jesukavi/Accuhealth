...
interface GovernorateModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (data: any) => void;
}

const GovernorateModal: React.FC<GovernorateModalProps> = ({ isOpen, onClose, onSubmit }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        onSubmit(formData);
        setFormData({ code: '', governorate: '', isActive: true });
        onClose();
    };
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden animate-scale-in">
                ...
                <div className="bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between">
                    <h2 className="text-xl font-bold text-gray-800">Governorate</h2>
                    <button
                        onClick={onClose}
